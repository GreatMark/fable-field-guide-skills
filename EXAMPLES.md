...
**Triggers:** "blindspot pass", "盲区扫描", "unknown unknowns", "what don't I know before diving in"
...
**Triggers:** "design directions", "出几个设计方向", "做个原型看看", "make me something to react to"
...
**Triggers:** "interview me", "访谈我", "问我问题"
...
each with why-it-matters; ends with a paste-ready decision record.
...
will port (and won't), confirms with you, then reimplements in your stack's
idioms — never a verbatim copy.

## implementation-plan

**Triggers:** "implementation plan", "实现计划", "写个实现方案"
...
**Triggers:** "pitch doc", "explainer", "提案文档", "打包给评审"
...
**Expect:** one self-contained file that leads with the demo, explains the
problem and decisions, pre-answers the questions expert reviewers would
probe, and states limitations honestly.

## change-quiz

**Triggers:** "quiz me", "考考我", "change quiz"
