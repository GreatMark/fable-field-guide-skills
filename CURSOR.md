...
The same `SKILL.md` format works in both tools. In Claude Code you can
install this repo as a plugin instead (see [README](./README.md#install)),
which keeps the skills updatable via the marketplace; in Cursor the copy
